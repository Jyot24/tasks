...
router.post('/auth',
    [
        body("First", ['please enter valid value']).isLength({ min: 2 }),
        body("last", ['please enter valid value']).isLength({ min: 2 }),
        body("Designation", ['please enter valid value']).isLength({ min: 2 }),
        body("address1", ['please enter valid value']).isLength({ min: 2 }),
        // body("address2",['please enter valid value']).isLength({ min: 2 }),
        body("Phone", ['please enter valid value']).isLength({ min: 2 }),
        body("gender", ['please enter valid value']).isLength({ min: 2 }),
        body("relationshipstatus", ['please enter valid value']).isLength({ min: 2 }),
        body("dob", ['please enter valid value']).isDate(),
        body("Email", ['please enter valid value']).isEmail(),
        body("state", ['please enter valid value']).isLength({ min: 2 }),
        // body("zipcode", ['please enter valid value']).isNumeric({ min: 2 }),
        // body("SSCBoard", ['please enter valid value']).isLength({ min: 2 }),
        // body("SSCPassiong", ['please enter valid value']).isLength({ min: 2 }),
        // body("SSCPercentage", ['please enter valid value']).isNumeric({ min: 2 }),
        // body("HSCBoard", ['please enter valid value']).isLength({ min: 2 }),
        // body("HSCPercentage", ['please enter valid value']).isNumeric({ min: 2 }),
        // body("HSCPassiong", ['please enter valid value']).isLength({ min: 2 }),
        // body("beCourse", ['please enter valid value']).isLength({ min: 2 }),
        // body("beUniversity", ['please enter valid value']).isLength({ min: 2 }),
        // body("bePassiong", ['please enter valid value']).isLength({ min: 2 }),
        // body("bePercentage", ['please enter valid value']).isNumeric({ min: 2 }),
        // body("mdCourse",['please enter valid value']).isLength({ min: 2 }),
        // body("mdUniversity",['please enter valid value']).isLength({ min: 2 }),
        // body("mdPercentage",['please enter valid value']).isLength({ min: 2 }),
        // body("mdPassiong",['please enter valid value']).isLength({ min: 2 }),
        // body("company",['please enter valid value']).isLength({ min: 2 }),
        // body("workDesignation",['please enter valid value']).isLength({ min: 2 }),
        // body("From",['please enter valid value']).isLength({ min: 2 }),
        // body("to",['please enter valid value']).isLength({ min: 2 }),
        // body("ReferanceName",['please enter valid value']).isLength({ min: 2 }),
        // body("ReferanceContact",['please enter valid value']).isLength({ min: 2 }),
        // body("Relation",['please enter valid value']).isLength({ min: 2 }),
        body("preferdlocation", ['please enter valid value']).isLength({ min: 2 }),
        body("Noticeperiod", ['please enter valid value']).isNumeric(),
        body("ExpactedCtc", ['please enter valid value']).isNumeric(),
        body("CurrentcTC", ['please enter valid value']).isNumeric(),
        body("department", ['please enter valid value']).isLength({ min: 2 }),
...
router.post('/update/',
    [
        ...
        // // body("ReferanceContact",['please enter valid value']).isLength({ min: 2 }),
        // // body("Relation",['please enter valid value']).isLength({ min: 2 }),
        // body("prefedlocation", ['please enter valid value']).isLength({ min: 2 }),
        // body("Noticeperiod", ['please enter valid value']).isNumeric(),
        // body("ExpactedCtc", ['please enter valid value']).isNumeric(),
        // body("CurrentcTC", ['please enter valid value']).isNumeric(),
        // body("department", ['please enter valid value']).isLength({ min: 2 }),
